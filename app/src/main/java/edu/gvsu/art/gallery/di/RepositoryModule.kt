...
internal val repositoryModule = module {
    single { ArtGalleryClient.create(baseURL = BuildConfig.ART_GALLERY_BASE_URL) }
    ...
    single<ArtworkSearchRepository> { DefaultArtworkSearchRepository(database = get(), client = get()) }
