...
@Composable
fun ArtworkVideoRow(links: List<URL>, onClick: (link: URL) -> Unit) {
    Column(
        ...
        Row(
            ...
            links.forEach { link ->
                Box(
                    ...
                    ArtworkVideoPlaceholder(url = link)
                }
            }
...
fun PreviewArtworkVideoRow() {
    val urls = listOf(URL("https://example.com/test"))

    ArtGalleryTheme {
        ArtworkVideoRow(urls) {}
    }
}